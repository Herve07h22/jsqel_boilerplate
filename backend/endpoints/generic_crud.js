...
const checkValidInteger = message => value => !isNaN(value) ? ({success: true, value}) : ({success: false, message: message })
...
const updateItem = {
    ...
    beforeQuery : (query, params ) => Object.assign( {}, params, {names:Object.keys(params.data)}, {values:Object.keys(params.data).map(k => params.data[k] )}, {id:params.data.id} ),
}
